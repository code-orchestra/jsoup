...
public class Document extends Element {
    ...
    public Document(String baseUri) {
        super(Tag.valueOf("#root"), baseUri, 0);
...
//        Element element = new Element(Tag.valueOf(tagName), this.baseUri());
//        element.setOffset(-1);
//        return element;
//    }
...
//
//        if (htmlEl == null)
//            htmlEl = appendElement("html").syntetic();
//        if (head() == null)
//            htmlEl.prependElement("head").syntetic();
//        if (body() == null)
//            htmlEl.appendElement("body").syntetic();
//
