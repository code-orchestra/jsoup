...
public class Element extends Node {
     ...
     */
    public Element(Tag tag, String baseUri, Attributes attributes, int offset) {
        super(baseUri, attributes, offset);
     ...
     */
    public Element(Tag tag, String baseUri, int offset) {
        this(tag, baseUri, new Attributes(), offset);
    }
    ...
    public Element appendElement(String tagName) {
        Element child = new Element(Tag.valueOf(tagName), baseUri(), -1);
        appendChild(child);
        return child;
    }
