...
enum TokeniserState {
    ...
    TagOpen {
        ...
        void read(Tokeniser t, CharacterReader r) {
            switch (r.current()) {
                ...
                default:
                    if (r.matchesLetter()) {
                        t.createTagPending(true, r.getPos());
    ...
    EndTagOpen {
        void read(Tokeniser t, CharacterReader r) {
            if (r.isEmpty()) {
                ...
                t.createTagPending(false, r.getPos());
                t.transition(TagName);
            } else if (r.matches('>')) {
                t.error(this);
    ...
    RcdataLessthanSign {
        ...
        void read(Tokeniser t, CharacterReader r) {
            if (r.matches('/')) {
                ...
                t.tagPending = new Token.EndTag(t.appropriateEndTagName(), r.getPos());
                t.emitTagPending();
                r.unconsume(); // undo "<"
                t.transition(Data);
            } else {
    ...
    BogusComment {
        void read(Tokeniser t, CharacterReader r) {
            ...
            r.unconsume();
            Token.Comment comment = new Token.Comment(r.getPos());
            comment.bogus = true;
    ...
    MarkupDeclarationOpen {
        void read(Tokeniser t, CharacterReader r) {
            if (r.matchConsume("--")) {
                t.createCommentPending(r.getPos());
    ...
    Doctype {
        void read(Tokeniser t, CharacterReader r) {
            ...
            switch (c) {
                ...
                case eof:
                    t.eofError(this);
                    t.createDoctypePending(r.getPos());
