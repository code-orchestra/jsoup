...
abstract class Token {
    ...
    static class StartTag extends Tag {
        ...
        StartTag(String name, int pos) {
            this(pos);
            this.tagName = name;
        }

        StartTag(String name, Attributes attributes, int pos) {
            this(pos);
            this.tagName = name;
